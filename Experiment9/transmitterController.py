...
tx_pin = Pin(19,Pin.OUT,value=0) #changed to 18
device_addr = 0x01
...
def main():
 ...
 # Determine which LED to turn on based on joystick direction
            ...
            elif abs(current_x - joystick_center_x) <= joystick_threshold and abs(current_y - joystick_center_y) <= joystick_threshold:
                transmitter.transmit(device_addr,0x05)
                print("COMMANDS",hex(0x05),"TRANSMITTED.") #stop both
